...
\doi{}
% TODO: insert confirmed ORCID
% TODO: insert confirmed University of Sydney email
...
\address[1]{School of Electrical and Computer Engineering, The University of Sydney, Sydney, NSW, Australia}
\corresp{Corresponding author: Jinghang Mei (email address to be confirmed).}
...
Code, trial-level data, derived analyses, figure-generation scripts, decoder provenance, and deterministic seed specifications are available at the project repository, \url{https://github.com/surnamemei/wspr-beyond-linear-drift}. The staged figures in this source tree are presentation copies; the validated result files remain unchanged.
% TODO: insert a Zenodo DOI only after one has been finalized and verified.
