...
The repository contains the trial-level CSV files, derived analyses, figure-generation scripts, decoder provenance, and deterministic seed rules used for every numerical result. The staged figures in this source tree are presentation copies; the validated result files remain unchanged.
